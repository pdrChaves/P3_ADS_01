...
void listarChamados() {
    ...
    for (int i = 0; i < totalChamados; i++) {
        ...
        fprintf(arquivo, "Codigo: %d, Setor: %s, Solicitante: %s, Hora: %d, Data: %d/%d/%d\n",chamados[i].codigo, chamados[i].setor, chamados[i].solicitante, tm.tm_mday, tm.tm_mon + 1, tm.tm_year + 1900
);
        printf("Codigo: %d, Setor: %s, Solicitante: %s, Hora: %d, Data: %d/%d/%d\n",chamados[i].codigo, chamados[i].setor, chamados[i].solicitante, tm.tm_mday, tm.tm_mon + 1, tm.tm_year + 1900
);
